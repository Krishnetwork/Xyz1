...
async def start_command(event):
    ...
    await event.respond(
        ...
        buttons=[
            [Button.url("Support Channel", url="https://t.me/Krishnetwork")],
            [Button.url("Support Group", url="https://t.me/Krishnetwork")],
        ],
        file='https://envs.sh/TES.jpg',  # Replace with your image URL
    )
